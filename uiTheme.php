    ...
    protected function getHeader()
    {
        $html = '<!doctype html>
				...
				<head>
					...
					<style>.ui-dialog-titlebar-close {
					  visibility: hidden;
					}></style><script src="js/jquery-1.9.1.js"></script>
		...
		<div id="tabs" style="height:700px">
		  <ul>
		    ...
		    <li><a id="tab1" href="rem.php' . $this->urlPara . '" onclick="$.cookie(\'tab\', 0); location.reload();">Reminders</a></li>
		    <li><a id="tab2" href="sub.php' . $this->urlPara . '" onclick="$.cookie(\'tab\', 1); location.reload();">Subcriptions</a></li>
		    <!--<li><a id="tab3" href="#profile' . $this->urlPara . '" onclick="$.cookie(\'tab\', 2); $.cookie(\'reload\', 1);">Profile</a></li>-->
