...
class ScheduleTest  extends PHPUnit_Framework_TestCase{
        ...
        public function testSchedule(){
                ...
                $schedule=new Schedule_temp(self::$userId, 'testing schedule 1', 'this schedule is created for testing','2013-01-01');
                ...
                $this->assertTrue($schedule->dateExpire=='2013-01-01 00:00:00');
                ...
                $this->assertTrue($schedule->dateUpdated!=null);
                var_dump($schedule->dateExpire);
                $this->assertTrue($schedule->dateExpire=='2013-09-27 00:00:00');
        }
}
