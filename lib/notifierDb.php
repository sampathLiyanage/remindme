 ...
 *for notification manager component
 */
class Notifier_DB extends DB_connection
{
    public function __construct()
    {
        parent::__construct("notifyManager", "tnX5XjsdCSWPfTFc");
    }

    /*
     * @input=>date:string
     * @output=>reminders:sql result object
     */
    public function getReminders($date)
    {
        $stmt = $this->prepareSqlStmt("SELECT remindList.title, remindList.description,
