...
class RemindListForm extends Form
{
    ...
    public function getHtml()
    {
		...
		<tr><td></td><td><button onclick="location.href=\'home.php?act=allRemindLists\'; return false;">Close</button></td></tr>
		</table>
		</form>';
        return $html;
    }
...
class ReminderForm extends Form
{
    ...
    public function getHtml()
    {
        $html = '<h3>Reminder details</h3>
                  ...
                  <tr><td>Message: </td><td><textarea name="description" >' . $this->description . '</textarea></td></tr>
...
class RemindListEditForm extends RemindListForm
{
    ...
    private function setHtml()
    {
        ...
        $this->html .= '"></td></tr><tr><td></td><td><input type="submit" name="submit" value="Close" 
                    onclick="location.href=\'home.php?act=allRemindLists\'; return false"></td></tr>
		</table>
		</form>';
    }
...
class ReminderEditForm extends ReminderForm
{
    ...
    public function setHtml()
    {
        ...
        $this->html .= '"></td></tr><tr><td></td><td><input type="submit" name="submit" value="Close"
                onclick="location.href=\'home.php?act=allRemindlistReminders&id=' . $this->RemindListId . '\'; return false;">';
...
/*
 * represents the subscription form
 */
class SubscriptionForm extends Form
{
    ...
    public function getHtml()
    {
        ...
        if (isset($_COOKIE['clsbtn'])) {
            $html .= '></td></tr><tr><td></td><td><button name="close" onclick="';
            $html .= "location.href='home.php?act=allSubscriptions'; $.removeCookie('clsbtn'); return false;\">Close</button";
        }
        $html .= '></td></tr>
		</table>
		</form>';
