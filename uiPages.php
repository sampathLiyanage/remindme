...
/**
 * represents remind list page in reminders tab
 */
...
/**
 * represents reminders page in reminders tab
 */
class RemindersPage extends Page
{
    ...
    public function getHtml($pageNo = 1)
    {
        ...
        $html .= '<div><div align="left" style="border:1px solid black; margin-left:20%">
                <table><tr>
                <td>Reminder list title: <b>' . $remindlist->title . '</b></td><td></td></tr>
                <tr><td>Created on : <b>' . $remindlist->dateCreated . '</b></td> 
                <td>&emsp;&emsp;&emsp;</td><td>Updated on : <b>' . $remindlist->dateUpdated . '</td>
                </tr><tr>
                <td>Publish status : <b>' . $pubStatus . '</b></td> 
                <td>&emsp;&emsp;&emsp;</td><td>public token : <b>' . $token . '</td>
                </tr>
...
/**
 * represents subscriptions page is subscription tab
 */
class subscriptionPage extends Page
{
    public function getHtml($pageNo = 1)
    {
        ...
        $html         = '
            ...
            <li ><a href="#" onclick="location.href=\'home.php?act=newsubscription\'; $.cookie(\'clsbtn\', 1); ">Subscribe</a></li>
            </ul></div>';
        if ($remindlists != false) {
            $html .= '<div style="float:left; margin-left:20%; width:50%">page:';
            for ($i = 1; $i <= $noOfPages; $i++) {
            ...
            foreach ($remindlists as $tdlist) {
                $html .= '<h3><table ><tr><td width="70%">' . $tdlist->title . '</td>
                            <td ><input type="submit"  value="Show" onclick="location.href=\'home.php?act=allSubReminders&id=' . $tdlist->id . '\';"/></td>
...
/**
 * represents reminders page in subscriptions tab
 */
class SubcribedRemindersPage extends Page
{
    ...
    public function getHtml($pageNo = 1)
    {
        ...
        $list                  = $sManager->getSubscribedRemindList($this->remindListId);
        $this->remindListTitle = $list[1];
        ...
        $html .= '<div><div align="center" style="border:1px solid black; margin-left:20%">
                <table><tr>
                <td>Remind-list title: <b>' . $this->remindListTitle . '</b></td>
                </tr><tr>
        ...
        if ($reminders !== false) {
            $html .= '<div style="float:left; margin-left:20%; width:50%">page:';
            for ($i = 1; $i <= $noOfPages; $i++) {
                $html .= '<a onclick="location.href=\'home.php?act=allSubReminders&id=' . $this->remindListId . '&page=' . $i . '\'">' . $i . '</a>';
            }
            $html .= '<br><br></div>';
            $html .= '
